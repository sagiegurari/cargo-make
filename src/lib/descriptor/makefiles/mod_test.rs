...
fn makefile_build_file_increment_file_exists_test() {
    let mut file = test::get_temp_test_directory("makefile_build_file_increment_file_exists_test");
...
fn makefile_build_file_increment_panic_invalid_data_test() {
    let mut file =
        test::get_temp_test_directory("makefile_build_file_increment_panic_invalid_data_test");
